  ...
  return (
    ...
    >
      <form action={onAction} className="space-y-4">
        <FormInput id="title" label={t("title")} type="text" errors={fieldErrors} placeholder="Enter Contract title" />
        <FormInput id="value" label={t("value")} type="text" errors={fieldErrors} placeholder="Enter Contract value"/>
        <FormDatePicker
          id="startDate"
          label={t("startDate")}
          type="hidden"
