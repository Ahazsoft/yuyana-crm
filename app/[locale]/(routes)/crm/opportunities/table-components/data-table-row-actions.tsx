// app/(crm)/crm/opportunities/components/DataTableRowActions.tsx
...
import { opportunitySchema } from "../table-data/schema";   // your opportunity schema
import { useRouter } from "next/navigation";
import AlertModal from "@/components/modals/alert-modal";
import { useState } from "react";
import { useToast } from "@/components/ui/use-toast";
import axios from "axios";
import { UpdateOpportunityForm } from "../components/UpdateOpportunityForm";   // the form we fixed
import {
  Sheet,
  SheetContent,
  SheetDescription,
  ...
  const onDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        title: "Error",
        description:
          "Something went wrong while deleting the opportunity. Please try again.",
      });
    } finally {
      setLoading(false);
      setOpen(false);
