...
export async function POST(req: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { newOpportunity: serializeBigInt(newOpportunity) },
      { status: 200 }
    );
  } catch (error) {
...
export async function PUT(req: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { updatedOpportunity: serializeBigInt(updatedOpportunity) },
      { status: 200 }
    );
  } catch (error) {
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const data = {
      ...
      contacts: serializeBigInt(contacts),
      saleTypes: serializeBigInt(saleTypes),
      saleStages: serializeBigInt(saleStages),
      campaigns: serializeBigInt(campaigns),
      industries: serializeBigInt(industries),
    };
...
//     return NextResponse.json(
//       JSON.parse(
//         JSON.stringify({ newOpportunity }, (_, value) =>
//           typeof value === "bigint" ? value.toString() : value
//         )
//       ),
//       { status: 200 }
